...
export default function MentorTip() {
	...
	return (
		<div className="bg-card rounded-xl p-6 border border-borderDark bg-gray-800">
			...
			<div className="bg-cardLight rounded-lg py-4 text-base text-textSecondary">Small daily wins beat big random efforts. So, stay consistent !!</div>
